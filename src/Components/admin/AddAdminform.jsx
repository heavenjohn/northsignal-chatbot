...
const AdminRegistrationForm = () => {
  ...
  const [pageTitle, setPageTitle] = useState("Admin Registration");
          ...
          <div className="max-w-4xl w-full mx-auto bg-white p-6 rounded-lg shadow-lg mt-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mt-6">
                <button
                  type="submit"
                  className={`w-full p-3 bg-primary text-white rounded-md font-semibold ${loading ? "bg-gray-500 cursor-not-allowed" : "hover:bg-blue-700"}`}
                  disabled={loading}
                >
